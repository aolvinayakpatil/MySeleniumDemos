...
public class TC03_TruckPlatinum {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		//Select Price Option
		String expPrice = "1,525.00", expClaim = "Submit", expDis = "5", expCover = "Limited", actPrice, actClaim, actDis, actCover;
		...
		System.out.println("Checking TC03-Truck - Platinum Values");
