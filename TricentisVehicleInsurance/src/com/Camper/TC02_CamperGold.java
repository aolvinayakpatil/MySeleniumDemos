...
public class TC02_CamperGold {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		//Select Price Option
		String expPrice = "733.00", expClaim = "Submit", expDis = "2", expCover = "Limited", actPrice, actClaim, actDis, actCover;
		...
		System.out.println("Checking TC02-Camper - Gold Values");
