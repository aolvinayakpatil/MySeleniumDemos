...
public class TC04_CamperUltimate {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		//Select Price Option
		String expPrice = "2,743.00", expClaim = "Submit", expDis = "10", expCover = "Unlimited", actPrice, actClaim, actDis, actCover;
		...
		System.out.println("Checking TC04-Camper - Ultimate Values");
