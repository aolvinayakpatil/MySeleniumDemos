...
public class TC04_MotorcycleUltimate {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		driver.findElement(By.id("cylindercapacity")).sendKeys("2");
		...
		//Select Price Option
		String expPrice = "2,516.00", expClaim = "Submit", expDis = "10", expCover = "Unlimited", actPrice, actClaim, actDis, actCover;
		...
		System.out.println("Checking TC04-Motorcycle - Ultimate Values");
