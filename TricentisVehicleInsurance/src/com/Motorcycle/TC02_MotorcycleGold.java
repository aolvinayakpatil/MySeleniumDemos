...
public class TC02_MotorcycleGold {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		//Select Price Option
		String expPrice = "673.00", expClaim = "Submit", expDis = "2", expCover = "Limited", actPrice, actClaim, actDis, actCover;
		...
		System.out.println("Checking TC02-Motorcycle - Gold Values");
