...
public class TC02_AutomobileGold {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		//Select Price Option
		String expPrice = "656.00", expClaim = "Submit", expDis = "2", expCover = "Limited", actPrice, actClaim, actDis, actCover;
		...
		System.out.println("Checking TC02-Automobile - Gold Values");
