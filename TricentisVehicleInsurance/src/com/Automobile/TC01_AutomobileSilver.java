...
public class TC01_AutomobileSilver {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		//Select Price Option
		String expPrice = "222.00", expClaim = "No", expDis = "No", expCover = "No", actPrice, actClaim, actDis, actCover;
		...
		System.out.println("Checking TC01-Automobile - Silver Values");
