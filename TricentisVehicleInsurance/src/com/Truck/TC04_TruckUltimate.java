...
public class TC04_TruckUltimate {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		//Select Price Option
		String expPrice = "2,906.00", expClaim = "Submit", expDis = "10", expCover = "Unlimited", actPrice, actClaim, actDis, actCover;
		...
		System.out.println("Checking TC04-Truck - Ultimate Values");
